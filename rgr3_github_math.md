...
| Модель | RSS | R² | RMSE | A, % | Прогноз при x*=67.7863 |
|---|---:|---:|---:|---:|---:|
...
```math
\hat\theta_1 = \frac{S_{xy}}{S_{xx}}, \qquad
...
```math
t_{\text{набл}} = \frac{\hat\theta_1}{SE(\hat\theta_1)} = 8.25762.
```
...
гипотеза H0 отвергается. Коэффициент при температуре статистически значим на уровне значимости 0.05.
